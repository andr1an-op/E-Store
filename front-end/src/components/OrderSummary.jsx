...
const stripePromise = loadStripe(
	"pk_test_51QGwpBLLqUuxctUOLHkWCqWs9vDEFmOIvavtHX8FpZ0vup8ocenjpe0pQzj032IQo7ic3yodssPooBisYAHy4dkc00wS9frTrI"
);
			...
			<div className='space-y-4'>
				<div className='space-y-2'>
					<dl className='flex items-center justify-between gap-4'>
						...
						<dd className='text-base font-medium text-white'>Rp{formattedSubtotal}</dd>
					</dl>
